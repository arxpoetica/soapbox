...
~~~sh
# getting the code
git clone git@github.com:nko4/xyzzy.git && cd ./xyzzy/

# developing
npm install
npm start

# deploying (to http://xyzzy.2013.nodeknockout.com/)
./deploy nko

# ssh access
ssh deploy@xyzzy.2013.nodeknockout.com
ssh root@xyzzy.2013.nodeknockout.com
# or, if you get prompted for a password
ssh -i ./id_deploy deploy@xyzzy.2013.nodeknockout.com
ssh -i ./id_deploy root@xyzzy.2013.nodeknockout.com
~~~
...
~~~html
<iframe src="http://nodeknockout.com/iframe/xyzzy" frameborder=0 scrolling=no allowtransparency=true width=115 height=25>
</iframe>
~~~
